...
#define N 256
  size_t cl_buff_size = N * N * sizeof(MATRIX_TYPE);
  ...
  Matrix_initRand(matA,N,0,valeur_max);
  //Matrix_initRand(matB,N,0,valeur_max);
  ...
  */
  ...
  cl_kernel ker = clCreateKernel(prg, "cholesky", NULL);
